...
public class LoginPage extends BasePage {
	...
	public void logintoapplication(String userName, String password) throws Exception  {
		...
		/*try {
			if (Constants.IsLightingEnabled =="False")
				Assert.assertTrue(driver.findElement(classic_home_tab).isDisplayed());
			else
				Assert.assertTrue(driver.findElement(lighting_home_tab).isDisplayed());
		...
		//Switch to Lighting - Classic
		//switchTo_Classic_Lightning();
	}
