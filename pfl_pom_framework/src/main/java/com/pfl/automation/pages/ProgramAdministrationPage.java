...
public class ProgramAdministrationPage extends BasePage {
		...
		By admin_program_name_column  = By.cssSelector("//th[@title='Name']/span");
		By admin_program_product_column = By.xpath("//th[@title='Product']/span");
		By admin_program_campaign_name_column  = By.xpath("//th[@title='Campaign Name']/span");
		
		By admin_program_budget_column  = By.xpath("//th[@title='Total Budget']/span");
		By admin_program_created_column  = By.xpath("//th[@title='Created']/span");
		By admin_program_updated_column  = By.xpath("//th[@title='Updated']/span");
		By admin_program_active_column  = By.xpath("//th[@title='Active']/span");
	    ...
	    public void verifyProgramAdministration(WebDriver driver) {
		...
		public void Search_ProgramAdministration(WebDriver driver, String text) {
			switchToFrame(driver);
